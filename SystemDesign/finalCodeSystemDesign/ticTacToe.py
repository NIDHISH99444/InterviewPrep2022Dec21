...
class TicTacToeGame(Game):
    ...
    def make_move(self, player, nextMove):
        self.board.is_available(nextMove.row, nextMove.col)
...
def tic_tac_toe_driver(board: TicTacToeBoard, players):
    ...
    while game.winner == None and board.empty > 0:
        ...
        row, col = list(map(int, moves.strip().split(" ")))
        print(row, col)
...
if __name__ == "__main__":
    ...
    players = [TicTacToePlayer("nidhish", Entity.CIRCLE.value), TicTacToePlayer("niharika", Entity.CROSS.value)]
